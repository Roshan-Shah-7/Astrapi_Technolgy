...
const Navbar = () => {
    ...
    return (
        <header className='w-full bg-transparent py-4 left-0 top-0 z-50 fixed'>
            <nav>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded-full backdrop-blur-sm bg-black/60">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:block">
                            <NavLink
                                to="/contact"
                                className="border border-gray-300 hover:bg-[#F7CA79] text-gray-300 hover:border-white hover:text-black px-4 py-2 rounded-lg transition-all duration-300"
                            >
                                contact
                            </NavLink>
                        </div>
